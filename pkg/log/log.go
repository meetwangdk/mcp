...
func NewLog(conf *viper.Viper) *Logger {
	...
	if conf.GetString("env") != "prod" {
		ZLog = &Logger{zap.New(core, zap.Development(), zap.AddCaller(), zap.AddStacktrace(zap.ErrorLevel))}
		return ZLog
	}
	ZLog = &Logger{zap.New(core, zap.AddCaller(), zap.AddStacktrace(zap.ErrorLevel))}
	return ZLog
}
