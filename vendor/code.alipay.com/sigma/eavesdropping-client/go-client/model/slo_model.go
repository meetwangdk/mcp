...
type SloTraceData struct {
	...
	DeliverySLONew                int64                  `gorm:"column:delivery_slo_new"`
	DeliveryDuration              time.Duration          `gorm:"column:delivery_duration"`
	DeleteDuration                time.Duration          `gorm:"column:delete_duration"`
	DeliverySLOReasonNew          string                 `gorm:"column:delivery_slo_reason_new"`
	DeliveryStatus                string                 `gorm:"column:delivery_status"`
	DeliveryStatusOrig            string                 `gorm:"column:delivery_status_orig"`
	DeliveryStatusNew             string                 `gorm:"column:delivery_status_new"`
	...
	ExtraProperties               map[string]interface{} `gorm:"column:extra_properties"`
	CreationResultAuditID         string                 `gorm:"column:creation_result_auditid"`
}
type Slodata struct {
	DocID                         string             `gorm:"column:doc_id" json:"omitempty"`
	...
	DeliverySLONew                int64              `gorm:"column:delivery_slo_new" json:"deliveryslonew,omitempty"`
	DeliveryDuration              time.Duration      `gorm:"column:delivery_duration" json:"deliveryduration,omitempty"`
	DeleteDuration                time.Duration      `gorm:"column:delete_duration" json:"deleteduration,omitempty"`
	DeliverySLOReasonNew          string             `gorm:"column:delivery_slo_reason_new" json:"deliverysloreasonnew,omitempty"`
	...
	DeliveryStatusNew             string             `gorm:"column:delivery_status_new" json:"deliverystatusnew,omitempty"`
