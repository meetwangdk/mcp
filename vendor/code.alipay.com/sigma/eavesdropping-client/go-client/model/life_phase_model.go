...
type LifePhase struct {
	...
	DataSourceId  string      `json:"dataSourceId,omitempty" gorm:"column:data_source_id"`
	...
	OperationName string      `json:"operationName,omitempty" gorm:"column:operation_name"`
	HasErr        bool        `json:"hasErr" gorm:"column:has_err"`
	SqlHasErr     string      `json:"sqlHasErr,omitempty" gorm:"column:has_err"`
	...
	Info          string      `json:"info,omitempty" gorm:"column:extra_info"`
}
