...
type PodYaml struct {
	...
	CreationTimestamp time.Time `json:"creationTimestamp,omitempty" gorm:"-"`
	StageTimestamp    time.Time `json:"stageTimestamp,omitempty" gorm:"column:stage_timestamp"`
	...
	ModelDeployment *metav1.OwnerReference `json:"modelDeployment,omitempty" gorm:"-"`
	ModelSet        *metav1.OwnerReference `json:"modelSet,omitempty" gorm:"-"`
}
