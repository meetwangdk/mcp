...
const (
	...
	// alpha: v1.16
	//
	// Enables support for watch progress notify.
	EtcdProgressNotify featuregate.Feature = "EtcdProgressNotify"

	// owner: @chuanyun.lcy
	// alpha: v1.14
	//
	// Enables etcd cache not ready.
	EtcdCacheNotReady featuregate.Feature = "EtcdCacheNotReady"

	// owner: @chenjun.cj
	// alpha: v1.14
	//
	// Enables support to set User-Agent/Resource/Verb QPS limiter through ConfigMap(kube-system/ua-qps-limiter)
	UserAgentQPSLimiter featuregate.Feature = "UserAgentQPSLimiter"

	// owner: @chenjun.cj (chenjun.cj@alibaba-inc.com)
	// alpha: v1.14
	//
	// Reflect User's group from other service
	ReflectUserGroup featuregate.Feature = "ReflectUserGroup"

	// owner: @baisha.lf
	// alpha: v1.14
	//
	// Disables label key value check.
	DisableLabelValidation featuregate.Feature = "DisableLabelValidation"
	// owner: @baisha.lf
	// alpha: v1.14
	//
	// Enable orphaned pod GC when pod is orphaned(spec.NodeName is not empty, but node is not exist)
	EnableOrphanedPodGC featuregate.Feature = "EnableOrphanedPodGC"

	// owner: @baisha.lf
	// alpha: v1.14
	//
	// Enable unscheduled pod GC when pod is Unscheduled(spec.NodeName is empty and deletionTimestamp is not null)
	EnableUnscheduledPodGC featuregate.Feature = "EnableUnscheduledPodGC"

	// owner: @baisha.lf
	// alpha: v1.14
	//
	// Set pod default dns policy to v1.DNSDefault
	EnableHostdnsAsDefault featuregate.Feature = "EnableHostdnsAsDefault"
)
...
var defaultKubernetesFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	EtcdProgressNotify:      {Default: false, PreRelease: featuregate.Alpha},
	EtcdCacheNotReady:       {Default: false, PreRelease: featuregate.Alpha},
	UserAgentQPSLimiter:     {Default: false, PreRelease: featuregate.Alpha},
	ReflectUserGroup:        {Default: false, PreRelease: featuregate.Alpha},
	DisableLabelValidation:  {Default: false, PreRelease: featuregate.Alpha},
	EnableOrphanedPodGC:     {Default: true, PreRelease: featuregate.Alpha},
	EnableUnscheduledPodGC:  {Default: true, PreRelease: featuregate.Alpha},
	EnableHostdnsAsDefault:  {Default: false, PreRelease: featuregate.Alpha},
}
